...
head(marks.set)
sapply(marks.set,class)  # numbers were imported as factors, need to numeric the out of them
marks.set$exam_1 <- as.numeric(levels(marks.set$exam_1))[marks.set$exam_1]
marks.set$exam_2 <- as.numeric(levels(marks.set$exam_2))[marks.set$exam_2]
