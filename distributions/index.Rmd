...
<a name="discrete">Discrete Distributions
========================================================

<a name="dunif">Discrete Uniform Distribution
-----------------------------------
...
<a name="binomial">Binomial Distribution
------------------------
...
<a name="multinomial">Multinomial Distribution
-------------------------
...
<a name="hypergeometric">Hypergeometric Distribution
-------------------------
...
<a name="poisson">Poisson Distribution
-------------------------
...
<a name="geometric">Geometric Distribution
-----------------
...
<a name="negbinomial">Negative Binomial Distribution
-----------------

The negative binomial distribution is a discrete probability distribution of the number of successes in a sequence of iid Bernoulli trials with probability of success $p$ before a _specified_ (non-random) number of failures (denoted $r$) occurs. It is also called Pascal Distribution (when $r$ is an integer).

For $x+r$ Bernoulli trials with success probability $p$, the negative binomial gives the probability of $x$ successes and $r$ failures, with a failure on the last trial.

Its pmf: $$f(x|p,r) = {x+r-1 \choose x} (1-p)^r p^x$$
...
R functions work in term of successess. The previous eg of throwing "1"s:
...
<a name="continuous">Continuous Distributions.
========================================================
...
<a name="unif">Uniform Distribution
-----------------
...
<a name="exp">Exponential Distribution
-----------------
...
<a name="gamma">Erlang Distribution
-----------------
...
<a name="gamma">Gamma Distribution
-----------------
...
<a name="normal">Normal Distribution
-----------------
...
<a name="dirichlet">Dirichlet Distribution
-----------------
